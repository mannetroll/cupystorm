...
cupystorm – 2D DNS simulation viewer

Installation:
  1. Drag cupystorm.app to the /Applications folder
  2. $ xattr -dr com.apple.quarantine /Applications/cupystorm.app
